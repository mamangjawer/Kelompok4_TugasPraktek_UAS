...
//* Color
Color cPrimary = const Color.fromARGB(255, 45, 107, 103);
Color cTextBlue = const Color.fromARGB(255, 75, 102, 80);
Color cLinear = const Color.fromARGB(255, 169, 223, 174);
const cBlack = const Color(0xff000000);
